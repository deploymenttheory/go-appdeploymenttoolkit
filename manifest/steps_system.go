...
func shortcutFromParams(p Params) adt.Shortcut {
	sc := adt.Shortcut{
	...
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.NewADTShortcut(ctx, sc)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTDesktopShortcut(ctx, name)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind:      bindService(adt.StartADTServiceAndDependencies),
	})
	register(StepSpec{
		Name: "service.stop", Summary: "Stop a service and its dependent services",
		Platforms: []Platform{PlatformWindows},
		Params:    serviceParams,
		Bind:      bindService(adt.StopADTServiceAndDependencies),
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.SetADTServiceStartMode(ctx, name, mode)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.SetADTEnvironmentVariableOptions{
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.SetADTEnvironmentVariable(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.RemoveADTEnvironmentVariableOptions{
				Variable: p.StringOr("variable", ""),
				Target:   p.StringOr("target", ""),
			}
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTEnvironmentVariable(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.AddADTFontOptions{FilePath: p.StringOr("filePath", "")}
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.AddADTFont(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.RemoveADTFontOptions{Name: p.StringOr("name", "")}
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTFont(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Platforms: []Platform{PlatformWindows},
		Params:    dllParams,
		Bind:      bindDll(adt.RegisterADTDll),
	})
	register(StepSpec{
		Name: "dll.unregister", Summary: "Unregister a DLL (regsvr32 /u)",
		Platforms: []Platform{PlatformWindows},
		Params:    dllParams,
		Bind:      bindDll(adt.UnregisterADTDll),
	})
}
...
func bindService(
	fn func(ctx context.Context, name string, opts ...adt.StartADTServiceAndDependenciesOptions) error,
) func(p Params) (adt.PhaseFunc, error) {
	return func(p Params) (adt.PhaseFunc, error) {
		name := p.StringOr("name", "")
		var opts []adt.StartADTServiceAndDependenciesOptions
		if wait, ok := p.Duration("pendingStatusWait"); ok {
			opts = append(opts, adt.StartADTServiceAndDependenciesOptions{PendingStatusWait: wait})
		}
		return func(ctx context.Context, s *adt.DeploymentSession) error {
...
func bindDll(fn func(ctx context.Context, filePath string) error) func(p Params) (adt.PhaseFunc, error) {
	return func(p Params) (adt.PhaseFunc, error) {
