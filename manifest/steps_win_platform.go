...
func init() {
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.SetADTActiveSetupOptions{
			...
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.SetADTActiveSetup(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.AddADTEdgeExtensionOptions{
			...
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.AddADTEdgeExtension(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.RemoveADTEdgeExtensionOptions{ExtensionID: p.StringOr("extensionId", "")}
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.RemoveADTEdgeExtension(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.InvokeADTSCCMTask(ctx, id)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.InstallADTSCCMSoftwareUpdates(ctx)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.UpdateADTGroupPolicy(ctx)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.EnableADTTerminalServerInstallMode(ctx)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.DisableADTTerminalServerInstallMode(ctx)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.MountADTWimFileOptions{
			...
			return func(ctx context.Context, s *deploy.Session) error {
				_, err := winadt.MountADTWimFile(ctx, opts)
				return err
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.DismountADTWimFileOptions{
				Path: p.StringOr("path", ""),
				Save: p.BoolOr("save", false),
			}
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.DismountADTWimFile(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.InvokeADTRegSvr32Options{
				FilePath: p.StringOr("filePath", ""),
				Action:   p.StringOr("action", ""),
			}
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.InvokeADTRegSvr32(ctx, opts)
			}, nil
		},
	})
}
