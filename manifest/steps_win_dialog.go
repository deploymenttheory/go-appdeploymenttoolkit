...
func init() {
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.ShowADTInstallationWelcomeOptions{
			...
			return func(ctx context.Context, s *deploy.Session) error {
				_, err := winadt.ShowADTInstallationWelcome(ctx, opts)
				return err
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.ShowADTInstallationProgressOptions{
			...
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.ShowADTInstallationProgress(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.CloseADTInstallationProgress(ctx)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.ShowADTInstallationRestartPromptOptions{
			...
			return func(ctx context.Context, s *deploy.Session) error {
				_, err := winadt.ShowADTInstallationRestartPrompt(ctx, opts)
				return err
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.ShowADTInstallationPromptOptions{
			...
			return func(ctx context.Context, s *deploy.Session) error {
				_, err := winadt.ShowADTInstallationPrompt(ctx, opts)
				return err
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := winadt.ShowADTDialogBoxOptions{
			...
			return func(ctx context.Context, s *deploy.Session) error {
				_, err := winadt.ShowADTDialogBox(ctx, opts)
				return err
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.ShowADTBalloonTip(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			opts := balloonOptionsFromParams(p)
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.ShowADTNotifyIcon(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (deploy.PhaseFunc, error) {
			return func(ctx context.Context, s *deploy.Session) error {
				return winadt.CloseADTNotifyIcon(ctx)
			}, nil
		},
	})
}
...
func balloonOptionsFromParams(p Params) winadt.ShowADTBalloonTipOptions {
	opts := winadt.ShowADTBalloonTipOptions{
