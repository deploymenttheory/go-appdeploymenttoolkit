...
func processOptionsFromParams(p Params) adt.StartADTProcessOptions {
	opts := adt.StartADTProcessOptions{
...
func init() {
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				_, err := adt.StartADTProcess(ctx, opts)
				return err
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.StartADTProcessAsUserOptions{
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				_, err := adt.StartADTProcessAsUser(ctx, opts)
				return err
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.BlockADTAppExecution(ctx, names)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.UnblockADTAppExecution(ctx)
			}, nil
		},
	})
	register(StepSpec{
	...
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.UpdateADTDesktop(ctx)
			}, nil
		},
	})
}
