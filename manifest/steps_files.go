...
func copyOptionsFromParams(p Params) adt.CopyADTFileOptions {
	opts := adt.CopyADTFileOptions{
...
func init() {
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.CopyADTFile(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.RemoveADTFileOptions{Recurse: p.BoolOr("recurse", false)}
			if v, ok := p.StringList("path"); ok {
				opts.Path = v
			}
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTFile(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			opts := adt.CopyADTFileToUserProfilesOptions{
				Path:                    base.Path,
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.CopyADTFileToUserProfiles(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.RemoveADTFileFromUserProfilesOptions{Recurse: p.BoolOr("recurse", false)}
			if v, ok := p.StringList("path"); ok {
				opts.Path = v
			}
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTFileFromUserProfiles(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.NewADTFolder(ctx, path)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.RemoveADTFolderOptions{
				Path:             p.StringOr("path", ""),
				DisableRecursion: p.BoolOr("disableRecursion", false),
			}
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTFolder(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			path := p.StringOr("path", "")
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				_, err := adt.CopyADTContentToCache(ctx, path)
				return err
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTContentFromCache(ctx)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.NewADTZipFile(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.SetADTIniValueOptions{
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.SetADTIniValue(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.IniValueOptions{
				FilePath: p.StringOr("filePath", ""),
				Section:  p.StringOr("section", ""),
				Key:      p.StringOr("key", ""),
			}
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTIniValue(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.IniSectionOptions{
				FilePath: p.StringOr("filePath", ""),
				Section:  p.StringOr("section", ""),
			}
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.RemoveADTIniSection(ctx, opts)
			}, nil
		},
	})
	register(StepSpec{
		...
		Bind: func(p Params) (adt.PhaseFunc, error) {
			opts := adt.SetADTItemPermissionOptions{
				Path:               p.StringOr("path", ""),
			...
			return func(ctx context.Context, s *adt.DeploymentSession) error {
				return adt.SetADTItemPermission(ctx, opts)
			}, nil
		},
	})
}
