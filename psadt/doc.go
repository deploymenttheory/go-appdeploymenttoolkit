// Package psadt is a Go port of PSAppDeployToolkit (PSADT) v4: a toolkit for
...
//	func main() {
//	    (&psadt.Deployment{
//	        Session: psadt.SessionOptions{Options: session.Options{
...
//	            _, err := psadt.StartADTProcess(ctx, psadt.ProcessOptions{
